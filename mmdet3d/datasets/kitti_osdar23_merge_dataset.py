...
class KittiOSDaR23Merge(Det3DDataset):
    r"""KittiOSDaR23Merge Dataset.

    This class serves as the API for experiments on the `KittiOSDaR23Merge Dataset
    ...
    # Important: Here the classes have to be identical to the KittiDataset
    ...
    def parse_ann_info(self, info: dict) -> dict:
        ...
        # In case the data is from the KITTI dataset
        
        if self.is_of_type_kitti(info['lidar_path']):
            ...
            # In case the data is from the OSDAR23 dataset
