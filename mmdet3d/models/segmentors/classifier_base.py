...
class BaseClassifier(BaseModel, metaclass=ABCMeta):
    ...
    def encode_classify(self, batch_inputs: Tensor,
        ...
        """Placeholder for encode images with backbone and classify """
        pass
    ...
    def postprocess_result(self, cls_logits_list: List[Tensor],
                           batch_data_samples: SampleList) -> SampleList:
        """Convert results list to `Det3DDataSample`.

        Args:
            cls_logits_list (List[Tensor]): List of classification logits.
        ...
        Returns:
            ...
            - ``pred_cls`` (Tensor): Predicted class label.
        """
