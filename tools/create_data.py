...
from mmdet3d.datasets.robosense_m1_plus_dataset import ROBOSENSE_M1_PLUS
...
def robosense_data_prep(root_path,
                    info_prefix,
                    version,
                    out_dir,
                    with_plane=False):
    
    """Prepare data related to ROBOSENSE_M1_PLUS dataset.
